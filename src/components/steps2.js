          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Click the button below to access the script download page.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Download the script</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Once on the script download page, click the download
                      button to get the script file.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Get your script key</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      After downloading the script, click the &apos;Get
                      Key&apos; button to receive your unique script key.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Use the script with your unique key and enjoy its features
                      in Roblox!
                    </span>
                  </Fragment>
                )}
