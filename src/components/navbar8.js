          ...
          <nav className="navbar8-links1">
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text21">#</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text15">Get Script</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Get Key</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text20">Script</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text25">Key</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1549888824-e50dfec595a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODI0MTYyNnw&ixlib=rb-4.1.0&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Script Image',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Site Logo',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Key Image',
  linkUrlPage1: 'https://www.teleporthq.io',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1704320372092-9bb74b2e966f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODI0MTYyNnw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1695192672186-aaa6f061f48a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODI0MTYyNnw&ixlib=rb-4.1.0&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1564691038808-85233054b622?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODI0MTYyNnw&ixlib=rb-4.1.0&q=80&w=1080',
